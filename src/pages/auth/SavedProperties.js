...
const SavedProperties = () => {
  ...
  const getSavedPropertiesData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.log(data, "saved properties data----------------------");
  ...
  console.log(likedData, "my_likeddata");
  ...
  return (
    <>
      <section>
        ...
        {totalData == 0 ? (
          <p className="dont_like_message">You didn't saved any property !!</p>
        ) : (
          <div className="row">
                ...
                <div className="col-lg-4 saved_col_properties">
                  ...
                  >
                    ...
                    <div className="like_div">
                      {likedData && likedData.includes(item.id) ? (
                        <div
