...
const Mortgage = () => {
  ...
  return (
    <>
      ...
      <section className="mortgage_main_section">
          ...
          <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12">
                      <p className="mortgage_disclaimer_para">
                        <span>Disclaimer </span>: PropFYI does not offer
                        financial or loan services, only licensed lenders do.
                        Our calculator is for math only and does not provide
                        loan estimates or quotes.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-4">
              <PieChart
                ...
                radius={40}
                label={({ dataEntry }) => {
                  if (dataEntry.title === "Principal & Interest") {
                    const annualPayment =
                      mortageData?.monthly_payment?.mortgage +
                      mortageData?.annual_payment?.property_tax +
                      mortageData?.annual_payment?.home_insurance +
                      mortageData?.monthly_payment?.hoa +
                      "/mo";
              ...
              <div className="graph_heading">
                <div>
                  <p className="mortage_lable mt-2">
                    <span className="principle_span"></span>Principal & Interest
                    (P & I):
                    <span className="principle_color">
                      {" "}
                      ${mortageData?.monthly_payment?.mortgage}
                    </span>
                  </p>
                  <p className="mortage_lable mt-2">
                    <span className="property_span"></span> Property Tax:
                    <span className="property_color">
                      ${mortageData?.annual_payment?.property_tax}
                    </span>
                  </p>
                  <p className="mortage_lable mt-2">
                    <span className="homeowner_span"></span>Homeowner's
                    insurance:{" "}
                    <span className="homeowner_color">${homeInsurance}</span>
                  </p>
                  <p className="mortage_lable mt-2">
                    {" "}
                    <span className="hoa_span"></span>HOA Fees:{" "}
                    <span className="hoa_color">${hoa}</span>
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="mortgage_calculator_form">
                <h2 className="mortage_heading mortage_main_heading">
                  Mortgage Calculator
                </h2>
                <p className="mortgage_disclaimer_para mortgage_dis_para">
                ...
                <div>
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <p className="mortage_lable mt-2">Property Tax ($)</p>
                      <input
                        type="number"
                        className="mortage_input"
                        value={propertyTax}
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <p className="mortage_lable mt-2">Home Insurance ($)</p>
                    <input
                      type="number"
                      className="mortage_input"
                      value={homeInsurance}
                  ...
                  <div className="col-lg-6">
                    <p className="mortage_lable mt-2">HOA Dues ($)</p>
                    <input
                      type="number"
                      className="mortage_input"
                      value={hoa}
